...
# ACDS 14.0 200 linux 2015.04.27.13:31:02
...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                  -work rsp_mux_004                
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_rsp_mux_004.sv"   -work rsp_mux_004                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                  -work rsp_mux_002                
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_rsp_mux_002.sv"   -work rsp_mux_002                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                  -work rsp_mux                    
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_rsp_mux.sv"       -work rsp_mux                    
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_rsp_demux_001.sv" -work rsp_demux_001              
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_cmd_mux_001.sv"   -work cmd_mux_001                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                  -work cmd_mux                    
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_cmd_mux.sv"       -work cmd_mux                    
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_cmd_demux_004.sv" -work cmd_demux_004              
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_cmd_demux_003.sv" -work cmd_demux_003              
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_cmd_demux_002.sv" -work cmd_demux_002              
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_cmd_demux.sv"     -work cmd_demux                  
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router_006.sv"    -work router_006                 
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router_005.sv"    -work router_005                 
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router_004.sv"    -work router_004                 
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router_002.sv"    -work router_002                 
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router.sv"        -work router                     
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                               -work sgdma_csr_rsp_width_adapter
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                           -work sgdma_csr_rsp_width_adapter
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                          -work sgdma_csr_rsp_width_adapter
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                  -work rsp_mux                    
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                          -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                               -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                           -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                           -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                               -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                               -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                            -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                           -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                             -work sgdma_csr_burst_adapter    
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                             -work pcie_ip_bar2_limiter       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                              -work pcie_ip_bar2_limiter       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                      -work pcie_ip_bar2_limiter       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                             -work pcie_ip_bar2_limiter       
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                 -work sgdma_csr_agent            
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                          -work sgdma_csr_agent            
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                -work pcie_ip_bar2_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                            -work sgdma_csr_translator       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                           -work pcie_ip_bar2_translator    
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L crosser -L rsp_mux_004 -L rsp_mux_002 -L rsp_demux_001 -L cmd_mux_001 -L cmd_demux_004 -L cmd_demux_003 -L cmd_demux_002 -L router_006 -L router_005 -L router_004 -L router_002 -L sgdma_csr_rsp_width_adapter -L sgdma_csr_burst_adapter -L pcie_ip_bar2_limiter -L sgdma_csr_agent_rsp_fifo -L sgdma_csr_agent -L pcie_ip_bar2_agent -L sgdma_csr_translator -L pcie_ip_bar2_translator -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L User_Module_0 -L altpll_qsys -L sdram -L sgdma -L pcie_ip -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
